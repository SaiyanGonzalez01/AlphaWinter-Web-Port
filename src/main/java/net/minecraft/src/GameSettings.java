...
public class GameSettings {
	...
	public boolean alphaSnow = false;
    public static boolean staticAlphaSnow = false;
		...
		try {
			...
			while(true) {
				...
				try {
					...
					if (var3[0].equals("alphaSnow")) {
                        this.alphaSnow = var3[1].equals("true");
                        staticAlphaSnow = alphaSnow;
                    }
	...
	public void saveOptions() {
		try {
			...
			var1.println("alphaSnow:" + this.alphaSnow);
            staticAlphaSnow = this.alphaSnow;
