...
public class GuiIngameMenu extends GuiScreen {
	...
	protected void actionPerformed(GuiButton var1) {
		...
		if (var1.id == 999) {
			...
			var1.displayString = "Alpha Snow: " + (this.mc.gameSettings.alphaSnow ? "ON" : "OFF");
			if (!this.mc.gameSettings.alphaSnow) {
				this.mc.theWorld.worldInfo.setRaining(false);
				this.mc.theWorld.worldInfo.setRainTime(12000);
			}
			BiomeGenBase.reloadBiomes();
